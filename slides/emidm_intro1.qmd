...
- Welcome! Today we’ll bridge **R and Python** for infectious disease modeling.
- We’ll explore Python basics for R users, a new IDE (Positron), and deep learning concepts.
- **Goal:** Equip you to leverage **PyTorch** (a popular deep learning framework) in epidemiological research.
...
- **Why use it?** Simplifies working on projects that use R **and** Python together, without switching IDEs.
